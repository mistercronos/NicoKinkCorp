...
if testuser == Nicolas121210:
    ...
    if testpass == 6:
        ...
        while ttd > 0:
            ...
            print "D: Calculate"
            print "E: Quit"
            print "F: Basic animation1"
            print "G: Basic animation2"
            print "H: Basic animation3"
            q = input("What would you like to do? ")
            if q == 260:
                print "You have chosen Change Password."
                print "This function is unavailable"
    ...
    class bcolors:
        ...
        BOLD = '\033[1m'
        UNDERLINE = '\033[4m'
    print bcolors.FAIL + "Username and Password do not match."
    print bcolors.FAIL + "If you wish to create an account, please conatct Nicolas Kress or Matthieu Choueiri"